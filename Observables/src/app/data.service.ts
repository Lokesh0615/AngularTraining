...
import { BehaviorSubject, Subject, AsyncSubject, ReplaySubject, interval } from 'rxjs'

@Injectable()
export class DataService implements OnInit {


    mobiles=["nokia",'mi', 'redmi','sam','oppo']
    // dataEmitter=new EventEmitter<string>();
    dataEmitter = new Subject<string>()

    // behavioralSubject
    dE = new BehaviorSubject(this.mobiles);
